    ...
    return (
        <nav className={`${toggle && '-translate-y-full'} bg-white p-[2rem_4rem] fixed right-0 w-full shadow-[0_-1px_25px_rgba(0,0,0,0.15)] rounded-t-3xl transition duration-300`}>
            <ul className="grid grid-cols-3 gap-x-8 text-center">
                <MobileNavbarLink path="/portfolio-website/" title="home" icon={Home} />
                <MobileNavbarLink path="/portfolio-website/projetos" title="projetos" icon={BriefcaseBusiness} />
                <MobileNavbarLink path="/portfolio-website/contato" title="contato" icon={SendHorizontal} />
            </ul>
