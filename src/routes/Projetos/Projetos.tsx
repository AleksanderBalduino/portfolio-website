                                                ...
                                                <div className='rounded-xl border border-gray-200 shadow group overflow-hidden relative'>
                                                    <div className="group flex flex-col space-y-1.5 p-6 relative w-full h-80 items-center justify-center overflow-hidden">
                                                        <div 
                                                            ...
                                                            style={{ backgroundImage: `url(src/assets/work/${project.image})` }}
                                                        ></div>
                                                    ...
                                                    {/* <div className={`flex flex-col space-y-1.5 p-6 relative w-full h-80 items-center justify-center bg-no-repeat bg-cover`}
                                                    style={{ backgroundImage: `url(src/assets/work/${project.image})` }}
                                                    >
                                                        <div className='flex gap-x-4'>
                                                            <Link to={project.link} target='_blank' className='bg-gray-800 w-[54px] h-[54px] rounded-full flex justify-center items-center scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 hover:bg-gray-500 transition-all duration-200'><Link2 className='text-white' /></Link>

                                                            <Link to={project.github} target='_blank' className='bg-gray-800 w-[54px] h-[54px] rounded-full flex justify-center items-center scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 hover:bg-gray-500 transition-all duration-200'><Github className='text-white' /></Link>
                                                        </div>
                                                    </div> */}
